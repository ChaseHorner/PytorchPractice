...
class SR_Unet(nn.Module):
    def __init__(
        ...
        self.in_conv1 = FirstFeature(n_channels, 32)
        self.in_conv2 = ConvBlock(32, 32)

        self.enc_1 = Encoder(32, 64)
        self.enc_2 = Encoder(64, 128)
        self.enc_3 = Encoder(128, 256)
        self.enc_4 = Encoder(256, 512)

        self.dec_1 = Decoder(512, 256)
        self.dec_2 = Decoder(256, 128)
        self.dec_3 = Decoder(128, 64)
        self.dec_4 = Decoder(64, 32)
